...
class DataAnalysisApp:
    ...
    def create_widgets(self):
        ...
        ttk.Button(self.tool_frame, text='Ровная линия', command=self.set_draw_mode).pack(fill=tk.X, padx=10, pady=2)
    ...
    def add_node(self):
        label = simpledialog.askstring("Object", "Введите название объекта:")
        if label:
